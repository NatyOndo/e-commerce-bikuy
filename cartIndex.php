...
<body>
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      <?php
  			include 'config.php';
  			$stmt = $conn->prepare('SELECT prodName,price1,price2,prodImage,prodDescription,prodId  FROM products');
  			$stmt->execute();
        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-body p-1">
              <h4 class="card-title text-center text-info"><?= $row['prodName'] ?></h4>
              <h5 class="card-text text-center text-danger"><i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['price2'],2) ?>/-</h5>
